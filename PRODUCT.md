...
> 最后更新：2026-07-10 · 线上版本 web@ddaab55 / cli@0.3.0
...
- [x] 画布协同上线部署（远程 D1 迁移 0002/0003 + deploy + CLI 0.3.0 发 npm）—— 2026-07-10 完成
...
| 版本 | 日期 | 内容 |
|---|---|---|
| web ddaab55 | 2026-07-10 | 画布协同全量上线 + P0/P1 体验修复（评论 resolve 闭环、首屏聚焦自愈、版本时间轴、变体归档、角色可见性） |
| cli 0.3.0 | 2026-07-10 | push `--base`/`--resolves`（并行变体检测、反馈关联解决，意图卡与评论 id 均支持）；SKILL.md 画布协作章节 |
